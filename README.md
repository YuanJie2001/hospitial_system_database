# hosptial_system_database
a project about database that is hosptial_system
我将其开源.但希望你能从中学习到数据库设计思想.
诚然,我不是一名DBA,我仅仅读过半本高性能MySQL(第3版)和一本数据库系统概论(第5版),一本java开发手册(华山版).
我从中掌握了一些知识将他们运用在了课程设计中.也许我的数据库课程设计不是最好,最优秀的对于这个项目结构来说.
...
因为去年重构过，当然也不希望大家直接抄，因此我仅编写了controller.demo文件。大家可参考其中代码，自行扩展。 
希望大家学业顺利！
